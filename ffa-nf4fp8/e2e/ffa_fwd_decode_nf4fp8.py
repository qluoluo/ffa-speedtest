...
try:
    from attn_kernel.attn_kernel_v1210_fused_bsz_nf4fp8 import attn_forward_decode_nf4 as _kernel
except Exception as exc:  # pragma: no cover - used for runtime diagnostics
    _IMPORT_ERROR = exc

    def attn_forward_decode_nf4fp8(*args: Any, **kwargs: Any):
        raise RuntimeError(
            "Failed to import nf4fp8 decode kernel. "
