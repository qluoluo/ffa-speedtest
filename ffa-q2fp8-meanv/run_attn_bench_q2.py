# Benchmarking & plotting for 2-bit K + fp8 residual attention kernel (mean-V fallback).
import argparse
import importlib
import math
import re
...
# Default kernel for q2 + fp8 residual (mean-V fallback)
from attn_kernel.attn_kernel_v1210_meanv_bsz_q2fp8 import attn_forward_decode_quantized
...
def parse_args():
    ...
    p.add_argument(
        "--kernel",
        type=str,
        default="attn_kernel.attn_kernel_v1210_meanv_bsz_q2fp8",
