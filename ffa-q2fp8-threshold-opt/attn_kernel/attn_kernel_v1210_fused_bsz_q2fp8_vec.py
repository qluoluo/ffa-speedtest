# attn_kernel_v1210_fused_bsz_q2fp8_vec.py
# 2-bit quantized K with fp8 residual refinement (vectorized load hints).
import math
...
def attn_compute_threshold_qbits(
    ...
    tl.multiple_of(offs_kp, 4)
    tl.max_contiguous(offs_kp, 4)
