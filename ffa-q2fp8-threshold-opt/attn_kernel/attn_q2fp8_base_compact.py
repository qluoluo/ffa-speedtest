# Compact keep-list variant (no low-reg BK tiling).
# - Stage1 appends kept block indices into kept_indices/kept_counts.
# - Stage2 iterates only kept blocks instead of scanning all NTBS.
# CUDAGraph wrapper for Q2FP8 decode kernel (compact keep list).
