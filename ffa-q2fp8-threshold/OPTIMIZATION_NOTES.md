...
This file consolidates optimization ideas near the Q2FP8 decode implementation.
...
- Threshold path: `attn_compute_threshold_qbits` precomputes thresholds once per
  (B, HKV); if thresholds are already available, skip the kernel and pass them
  to stage1.
