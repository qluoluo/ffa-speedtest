...
from attn_kernel.attn_kernel_v1210_fused_bsz_q2fp8_reuse_bs import attn_forward_decode_quantized
from attn_kernel.attn_kernel_v1210_fused_bsz_q2fp8_reuse_bs_cudagraph import (
...
def main():
    ...
    attn_kernel_name = "attn_kernel_v1210_fused_bsz_q2fp8_reuse_bs"
