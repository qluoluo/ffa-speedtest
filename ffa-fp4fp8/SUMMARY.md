...
## Method Summary
The method compresses K into FP4 values plus an FP8 residual to reduce bandwidth, and uses a threshold-based block pruning heuristic to skip blocks with low attention scores. Residuals recover part of the lost precision during attention computation.
