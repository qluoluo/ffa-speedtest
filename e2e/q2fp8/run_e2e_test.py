...
def load_ffa_model(
    ...
    """Load FFA-Q2FP8-Sym model."""
    print(f"Loading FFA-Q2FP8-Sym model from {model_path}...")
...
def benchmark_ffa(
    ...
    """Run FFA-Q2FP8-Sym benchmark with detailed timing."""
...
def benchmark_ffa_detailed(
    ...
    """Run FFA-Q2FP8-Sym benchmark with manual token-by-token generation for precise timing."""
    inputs = tokenizer(prompt, return_tensors="pt").to(device)
    prompt_length = inputs["input_ids"].shape[1]
...
def main():
    parser = argparse.ArgumentParser(description="FFA-Q2FP8-Sym end-to-end speed benchmark")
    ...
    print("=" * 70)
    print("FFA-Q2FP8-Sym End-to-End Speed Benchmark")
    print("=" * 70)
    ...
    if args.output:
        ...
        default_output = Path(__file__).parent / "q2fp8_result.json"
