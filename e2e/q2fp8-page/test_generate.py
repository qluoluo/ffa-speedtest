"""
Test script for FFA-Q2FP8-Page (with CUDA Graph) LlamaForCausalLM generation.

This test uses the q2fp8-page implementation which includes:
- Block-wise JIT CUDA Graph for decode acceleration
- Automatic graph capture and replay
- Memory-aware graph invalidation
...
def test_generate(
    ...
    """
    Test generation with FFA-Q2FP8-Page attention (with CUDA Graph).
    ...
    """
    print("=" * 60)
    print("FFA-Q2FP8-Page Generation Test (with CUDA Graph)")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="Test FFA-Q2FP8-Page generation with CUDA Graph")
    parser.add_argument(
        "--model_path",
        type=str,
